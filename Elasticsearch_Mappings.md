...
* __``creation_date``__: Creation date of the contribution. Field does not exist, remove from mapping.
...
* __``creation_date``__: Creation date of the subcontribution.  Field does not exist, remove from mapping.
* __``start_date``__: Starting date of the subcontribution.  Field does not exist, remove from mapping.
* __``end_date``__: Ending date of the subcontribution.  Field does not exist, remove from mapping.
