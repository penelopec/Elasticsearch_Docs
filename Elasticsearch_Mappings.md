...
* creation_date: Creation date of the contribution. Field does not exist, remove from mapping.
...
* creation_date: Creation date of the subcontribution.  Field does not exist, remove from mapping.
* start_date: Starting date of the subcontribution.  Field does not exist, remove from mapping.
* end_date: Ending date of the subcontribution.  Field does not exist, remove from mapping.
